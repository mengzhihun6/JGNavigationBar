...
@interface JGQQMineController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation JGQQMineController
...
{
    if (_imgView == nil) {
        _imgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"localImg10"]];

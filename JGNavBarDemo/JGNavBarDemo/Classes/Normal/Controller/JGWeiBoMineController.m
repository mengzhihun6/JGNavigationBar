...
@interface JGWeiBoMineController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation JGWeiBoMineController
...
{
    if (_iconView == nil) {
        _iconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"localImg10"]];
...
- (UILabel *)detailsLabel
{
    if (_detailsLabel == nil) {
        ...
        _detailsLabel.text = @"简介:中久科技公司，中久科技商家APP iOS工程师";

//
//  JGSecondMoveTypeController.m
//  JGNavBarDemo
//
//  Created by 郭军 on 2017/8/18.
...
@interface JGSecondMoveTypeController () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) UIImageView *imgView;

@end

@implementation JGSecondMoveTypeController
